...
// Notification routes
router.post("/notifications/send", notificationController.sendPushNotification);

// Google authentication
router.post("/auth/google", authController.handleGoogleAuth);

// Clerk authentication
router.post("/clerk/getuser", clerkAuthController.getUserByEmail);
router.post("/clerk/register", clerkAuthController.registerClerkUser);
router.post("/clerk/verify", clerkAuthController.verifyClerkToken);
